...
while(1==1):
	...
	if len(my_url)>=4:
		try:
			...
			search = '{"default":"' #defining unique javascript parts to seartch for the start
			search_end = '"}},"audio_versions' #defining unique javascript parts to seartch for the end
